...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.qrcodes.driver' => 'string',
            'filesystems.disks.qrcodes.root' => 'string',
            'filesystems.disks.qrcodes.url' => 'string',
            'filesystems.disks.qrcodes.visibility' => 'string',
            'filesystems.links.C:\laragon\www\qrmenu-app\public\storage' => 'string',
...
'filesystems.disks.media.url','filesystems.disks.media.visibility','filesystems.disks.qrcodes.driver','filesystems.disks.qrcodes.root','filesystems.disks.qrcodes.url',
'filesystems.disks.qrcodes.visibility','filesystems.links.C:\\laragon\\www\\qrmenu-app\\public\\storage','laravellocalization.supportedLocales.en.name','laravellocalization.supportedLocales.en.script','laravellocalization.supportedLocales.en.native',
'laravellocalization.supportedLocales.en.regional','laravellocalization.supportedLocales.es.name','laravellocalization.supportedLocales.es.script','laravellocalization.supportedLocales.es.native','laravellocalization.supportedLocales.es.regional',
...
'laravellocalization.urlsIgnored','laravellocalization.httpMethodsIgnored','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'responsecache.replacers','responsecache.cache_tag','responsecache.hasher','responsecache.serializer','services.postmark.token',
...
'view.paths','view.compiled','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'activitylog.activity_model','activitylog.table_name','activitylog.database_connection','media-library.disk_name','media-library.max_file_size',
...
'debugbar.queries.explain','cashier.payment','cashier.webhook','livewire.update','generated::ast0TraQUCMgkXru',
'generated::3Wl5xBGyy58AeUXP','livewire.upload-file','livewire.preview-file','generated::VOZJ8TR6FALopPbS','generated::07EME3hYOBGs4DTO',
'storage.local',);
        registerArgumentsSet('views', 
'cashier::invoice','cashier::payment','layouts.app','vendor.cashier.invoice','vendor.cashier.payment',
...
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','STRIPE_KEY',
'STRIPE_SECRET','STRIPE_WEBHOOK_SECRET','IYZICO_API_KEY','IYZICO_SECRET_KEY','IYZICO_BASE_URL',
'OPENAI_API_KEY','PUSHER_APP_ID','PUSHER_KEY','PUSHER_SECRET','PUSHER_CLUSTER',
